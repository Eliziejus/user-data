...
export class TableDataComponent{
  ...
  public getDate(birthday: string) { // convert date to age //TODO make it unitily function
...
//TODO padaryti kad visos funkcijos turetu public ar ne tik
  ...
  public deleteAll(){ // Erase all data form table and localstorage
    if (confirm("Are you sure to erase all profiles? ")) {
      ...
      this.profiles = []; //TODO move this functionalyti to dataService
    }
  }
